...
public class HistogramEqualizer extends javax.swing.JFrame {

    

    private GrayImage eqGrayImage;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmdEqualized = new javax.swing.JButton();
        setTitle("CS450 Imaging Project #2 -- Histogram Equalization");
        ...
        jLabel2.setText("CS450 Imaging Project #2 - Histogram Equalization");
        ...
        cmdInitiate.setBorder(new javax.swing.border.BevelBorder(0));
          ...
          cmdInitiate.setText("Generate Equalized Gray Image");
        ...
        jPanel5.setLayout(new java.awt.GridLayout(1, 2));
          ...
          cmdEqualized.setBorder(new javax.swing.border.BevelBorder(0));
            cmdEqualized.setFont(new java.awt.Font ("Garamond", 1, 18));
            cmdEqualized.setText("Show Equalized Histogram");
            cmdEqualized.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    cmdEqualizedActionPerformed(evt);
                }
            }
            );
            jPanel5.add(cmdEqualized);
  ...
  private void cmdEqualizedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdEqualizedActionPerformed

      if (eqGrayImage == null) createEqualizedImage();
      if (sgCanvas != null) jPanel3.remove(sgCanvas);
      createHistogram(eqGrayImage, ehgImage);
      
     
      JOptionPane.showMessageDialog(null, "Equalized Histogram Displayed");
  ...
  }//GEN-LAST:event_cmdEqualizedActionPerformed
  ...
  private void createEqualizedImage() {
    int i,j;
    float test;
    GrayImage t;
    if (chgImage == null) {
        hgImage = createHistogram(grayImage, hgImage);
        chgImage = new CumulativeHistogram(hgImage);
    }
    
    if (eqGrayImage == null) {
        area = grayImage.X() * grayImage.Y();
        for (i=0; i<=255; i++) {
            lookupTable[i] = (int) ( (float) ((float)chgImage.count(i)/(float) area) * (float) 255);
        }
        eqGrayImage = new GrayImage(grayImage.getData());
        for (i=0; i<eqGrayImage.X(); i++) {
            for (j=0; j<eqGrayImage.Y(); j++) {
                eqGrayImage.set(i,j,lookupTable[eqGrayImage.get(i,j)]);
            }
        }
        try {
            scrollPane2.add(canvas1 = new JImageCanvas(eqGrayImage));
    ...
    JOptionPane.showMessageDialog(null, "Equalized Image created displayed");  
  }
  ...
  private void cmdHistogramActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdHistogramActionPerformed
      ...
      jPanel3.validate();
      jPanel3.repaint();
      writeToFile(rsSignal, "C:\\histogram1.dat");
  ...
  private void writeToFile(GrayImage myImage, String filename) {
    ...
    */
    public static void main (String args[]) {
        HistogramEqualizer cg = new HistogramEqualizer ();
        //Load Image
    ...
    private javax.swing.JButton cmdEqualized;
