...
#define threadmessage "Thread Count is "
...
void CSimpleGUIDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, strThreadCount);
	//}}AFX_DATA_MAP
}
...
void CSimpleGUIDlg::OnUpdate(WPARAM w, LPARAM l) {
	...
	m_txtData += (char*) l;
	MessageBox((char*) l);
	itoa(threadcount, mycount, 10);
	strThreadCount = threadmessage;
	strThreadCount += mycount;
	UpdateData(false);
}
